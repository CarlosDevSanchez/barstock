...
| [C3](hallazgos/C3-dependencias-vulnerables.md) | Crítico | Dependencias | Next.js 16.1.6 y transitivas vulnerables | S | Abierto |
...
| [H3](hallazgos/H3-impuestos-y-dinero.md) | Alto | Lógica de negocio | Impuestos inconsistentes; float; `DECIMAL(5,2)` | M | Abierto |
| [H4](hallazgos/H4-flujos-incompletos.md) | Alto | Funcional | Recuperar contraseña roto; ajustes falsos; sin alta de stock; compras/gastos sin UI | M | Abierto |
| [H5](hallazgos/H5-build-sin-env.md) | Alto | DevOps | El build falla sin variables de entorno | S | Abierto |
