...
| Jornada y cajas | Se puede vender sin jornada ni caja: esas órdenes quedan con ambos ids nulos. El efectivo esperado no resta gastos (fase C). Tolerancia de arqueo 0. Un cron diario cierra jornadas de más de 24 h | [caja-y-jornada](docs/03-modulos/caja-y-jornada.md) |
