...
| Órdenes de compra, variantes | Solo esquema: sin API, UI ni reposición de stock al recibir. Los gastos operativos ya tienen API y pantalla | [proveedores](docs/03-modulos/proveedores-y-compras.md), [gastos](docs/03-modulos/gastos.md) |
